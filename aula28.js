...
// Fazendo requisições
    ...
    // Protocolos: GET, POST, Qualquer protocolo HTTP Válido
...
// Manipulando respostas
    ...
    // Response Text - traz a resposta da requisição em formato string, se for um JSON vc pode acessar as propriedades através desse método e ele retornará o valor
    // Response XML - tenta trazer a resposta da requisição em formato XML, se não for XML é necessário forçar 
